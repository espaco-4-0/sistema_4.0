...
export default function BlogCards({ id, category, title, image, size = "small" }: BlogCardsProps) {
    ...
    return (
        ...
        >
            ...
            />
            <div className="absolute-inset-0 bg-grandient-to-tfrom-black/80 via-black/40 to-transparent" />
