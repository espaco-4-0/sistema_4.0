            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <table className="w-full text-left">
                        <thead className="bg-gray-50 border-b border-gray-100">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase">Qtd Total</th>
                                <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase">Disponível</th>
                            ...
                            {currentItems.map((item) => (
                                <tr key={item.id} className="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-sm text-center">
                                        <button className="text-orange-400 hover:text-orange-600 font-medium"><MoreVertical/></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
                ...
                <div className="px-6 py-4 flex items-center justify-between border-t border-gray-100 bg-gray-50/50">
                    <p className="text-sm text-gray-500">
                        ...
                        <span className="font-medium">{filteredData.length}</span> componentes
                    </p>
