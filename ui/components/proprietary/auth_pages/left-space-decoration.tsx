            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex justify-center">
                    <h2 className="font-medium text-4xl text-center">
                        Novidades do<span
                                className="text-[#C49D00] font-bold">
                                {" "}Espaço 4.0!
                        </span>
                    </h2>
                </div>
                ...
                <div className="flex justify-center mt-14">
                    <Button
                        variant="outline"
                        className="border-2 cursor-pointer border-[#D1D5DC] px-8 py-3 rounded-md font-medium transition hover:bg-black hover:text-white"
                    >
                        Mais Notícias
                    </Button>
                </div>
