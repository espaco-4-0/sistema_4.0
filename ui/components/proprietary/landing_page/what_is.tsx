                        ...
                        <div className="max-w-7xl mx-auto px-6">
                                ...
                                <div className="justify-center items-center text-center flex flex-col mb-16">
                                        <h2 className="font-semibold text-4xl">
                                                O que e o{" "}
                                                <span className="text-[#C49D00] font-semibold">
                                                        Espaco 4.0 ?
                                                </span>
                                        </h2>

                                        <p className="text-xl text-gray-700 mt-6 max-w-3xl pt-8">
                                                Um Laboratorio maker equipado com tecnologias de ponta para promover
                                                inovação, prototipagem e desenvolvimento de projetos da indústria 4.0
                                        </p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 hover:cursor-default gap-6 mb-24">
                                        ...
                                        <Card className="flex flex-col items-center text-center transition-all duration-300">
                                                <CardTitle className="bg-[#FEF9C2] h-15 w-15 flex justify-center rounded-full items-center">
                                                        <Shell className="text-[#D08700] h-max w-max"/>
                                                </CardTitle>

                                                <CardContent className="font-semibold text-[18px]">
                                                        Gestão de Projetos
                                                </CardContent>
                                        ...
                                        <Card className="flex flex-col items-center text-center transition-all duration-300">
                                                <CardTitle className="bg-[#FEF9C2] h-15 w-15 flex justify-center rounded-full items-center">
                                                        <Users className="h-max w-max text-[#D08700]"/>
                                                </CardTitle>
                                        ...
                                        <Card className="flex flex-col items-center text-center transition-all duration-300">
                                                <CardTitle className="bg-[#FEF9C2] h-15 w-15 flex justify-center rounded-full items-center">
                                                        <BookOpen className="h-max w-max text-[#D08700]"/>
                                                </CardTitle>
                                        ...
                                        <Card className="flex flex-col items-center text-center transition-all duration-300">
                                                <CardTitle className="bg-[#FEF9C2] h-15 w-15 flex justify-center rounded-full items-center">
                                                        <Medal className="h-max w-max text-[#D08700]"/>
                                                </CardTitle>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                        ...
                                        <div className="flex flex-col gap-6">
                                                <h2 className="text-2xl flex font-medium items-center gap-2">
                                                        <span className="text-[#FDC700] font-bold">|</span>
                                                        <span className="text-black">Sobre o</span>
                                                        <span className="text-[#C49D00]">Espaço 4.0</span>
                                                </h2>

                                                <div className="text-[#4A5565] text-base leading-relaxed space-y-4">
                                                        <p>
                                                                O Espaço 4.0 é um laboratório de inovação do Instituto Federal de Alagoas
                                                                - Campus Arapiraca, dedicado a promover o desenvolvimento de competências
                                                                em tecnologias da quarta revolução industrial.
                                                        </p>

                                                        <p>
                                                                Com infraestrutura moderna e equipamentos de ponta, oferecemos aos
                                                                estudantes e à comunidade um ambiente propício para materializar ideias,
                                                                desenvolver protótipos e criar soluções inovadoras.
                                                        </p>

                                                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 text-center mt-24">
                                                                <div className="flex flex-col items-center">
                                                                        <span className="text-[#C49D00] text-4xl font-semibold">
                                                                                500+
                                                                        </span>
                                                                        <span className="text-[#4A5565] text-lg mt-2">
                                                                                Usuarios Ativos
                                                                        </span>
                                                                </div>
                                                                <div className="flex flex-col items-center">
